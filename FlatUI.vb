...
#Region " Variables"
    ...
    Friend _FlatColor As Color = Color.FromArgb(43, 128, 180)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            .FillRectangle(New SolidBrush(Color.FromArgb(43, 134, 189)), 16, 16, 4, 18)
...
#Region " Colors"
    ...
    Private _LimeGreen As Color = Color.FromArgb(43, 128, 180)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            .FillPath(New SolidBrush(Color.FromArgb(45, 47, 49)), GP3)

            '-- if ShowText
            If ShowText Then
                .DrawString(Text, Font, New SolidBrush(Color.FromArgb(43, 134, 189)), New Rectangle(16, 16, W, H), NearSF)
            End If
        End With
...
#Region " Colors"
    ...
    Private _HoverColor As Color = Color.FromArgb(43, 128, 180)
...
Class FlatLabel : Inherits Label
    ...
    Sub New()
        ...
        Font = New Font("Segoe UI", 8)
        ForeColor = Color.FromArgb(43, 134, 189)
        BackColor = Color.Transparent
        Text = Text
    End Sub
